...
def ui_flow():
    ...
    while arcane_loop_trial:
        menu_trial()
## solution
def reversing(key,username_trial):
    global key_full_template_trial
    ...
    if len(key) != len(key_full_template_trial):
        ...
        # Check dynamic part --v
        flag = key[:i]
        print(hashlib.sha256(username_trial).hexdigest()[4],hashlib.sha256(username_trial).hexdigest()[5])
        #key.replace(key[i],hashlib.sha256(username_trial).hexdigest()[4])
        ...
        #key.replace(key[i],hashlib.sha256(username_trial).hexdigest()[5])
        ...
        #key.replace(key[i],hashlib.sha256(username_trial).hexdigest()[3])
        i += 1
        ...
        """if key[i] != hashlib.sha256(username_trial).hexdigest()[3]:
            ...
            i += 1"""
        #key.replace(key[i],hashlib.sha256(username_trial).hexdigest()[6])
        ...
        """if key[i] != hashlib.sha256(username_trial).hexdigest()[6]:
            ...
            i += 1"""
        #key.replace(key[i],hashlib.sha256(username_trial).hexdigest()[2])
        ...
        """if key[i] != hashlib.sha256(username_trial).hexdigest()[2]:
            ...
            i += 1"""
        #key.replace(key[i],hashlib.sha256(username_trial).hexdigest()[7])
        ...
        """if key[i] != hashlib.sha256(username_trial).hexdigest()[7]:
            ...
            i += 1"""
        #key.replace(key[i],hashlib.sha256(username_trial).hexdigest()[1])
        ...
        """if key[i] != hashlib.sha256(username_trial).hexdigest()[1]:
            ...
            i += 1"""
        #key.replace(key[i],hashlib.sha256(username_trial).hexdigest()[8])
...
# Enter main loop
#ui_flow()
reversing(key_full_template_trial,bUsername_trial)
if jump_into_full:
